...
const Query = {
    ...
    subCategories: (parent, args, context) => __awaiter(void 0, void 0, void 0, function* () {
        const { prisma, user } = context;
        if (!user)
            throw new apollo_server_core_1.AuthenticationError("User not logged in");
        return yield prisma.subCategory.findMany();
    }),
    flashCards: (parent, args, context) => __awaiter(void 0, void 0, void 0, function* () {
        const { prisma, user } = context;
        if (!user)
            throw new apollo_server_core_1.AuthenticationError("User not logged in");
        return yield prisma.flashCard.findMany();
    }),
};
